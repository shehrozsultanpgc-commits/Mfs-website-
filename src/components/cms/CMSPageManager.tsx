...
export const CMSPageManager: React.FC<CMSPageManagerProps> = ({
  ...
  const [pages, setPages] = useState<PageItem[]>([
    ...
    },
    {
      ...
      metaDescription: 'Learn about MFS Growth Agency, a premier digital agency delivering 24/7 expert services worldwide.',
    ...
    },
    {
      ...
      metaDescription: 'Reach out to MFS Growth Agency via WhatsApp +92 301 5323689 or email mfsmedia.agency@gmail.com for instant assistance.',
      keywords: ['contact MFS agency', 'MFS whatsapp number', 'agency support contact', 'online support hub'],
      isSystemPage: true,
    },
    {
      id: 'page-9',
