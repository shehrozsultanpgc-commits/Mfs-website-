...
export const CMSBrandAssetCenter: React.FC<CMSBrandAssetCenterProps> = ({
  ...
  const [brandAssets, setBrandAssets] = useState<BrandAsset[]>([
    {
      id: 'brand-1',
      title: 'MFS Primary Gold Logo',
      type: 'logo',
      variant: 'Dark Canvas / Gold Accent',
      format: 'SVG / PNG (300 DPI)',
      dimensionsOrValue: '1920x1080 px',
      url: '/logo.svg',
      version: 'v2.4 (Latest)',
    ...
    {
      id: 'brand-2',
      title: 'MFS Monochrome Light Logo',
      type: 'logo',
      variant: 'Light Print / White Canvas',
      format: 'SVG / PNG',
      dimensionsOrValue: '1920x1080 px',
      url: '/logo.svg',
      version: 'v2.1',
    ...
    },
    {
      ...
      format: 'ICO / PNG (512x512)',
      dimensionsOrValue: '512x512 px',
      url: '/favicon.ico',
      version: 'v2.0',
