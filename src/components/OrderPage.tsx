                        ...
                        <div className="p-3 rounded-2xl bg-[#08080C] border border-[#E5C158]/30 space-y-2">
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            <button
                              ...
                              className="py-2 px-3 rounded-xl bg-white text-black font-extrabold text-[11px] hover:bg-neutral-100 transition-all cursor-pointer flex items-center justify-center gap-2 border border-neutral-300 shadow-sm"
                            >
                            ...
                            <button
                              ...
                              className="py-2 px-3 rounded-xl bg-[#1877F2] text-white font-extrabold text-[11px] hover:bg-[#166fe5] transition-all cursor-pointer flex items-center justify-center gap-2 shadow-sm"
                            >
                              <span>Facebook</span>
                            </button>
                          </div>
